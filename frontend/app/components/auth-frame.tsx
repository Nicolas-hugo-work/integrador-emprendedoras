    ...
    <main className="grid min-h-screen bg-background lg:grid-cols-[0.9fr_1.1fr]">
      <section className="relative hidden overflow-hidden bg-primary p-12 text-primary-foreground lg:flex lg:flex-col">
        ...
        <Link href="/" className="relative flex items-center gap-3">
          ...
          <strong className="font-heading text-xl">Kawsay</strong>
        </Link>
        <div className="relative my-auto max-w-lg">
          ...
          <h2 className="mt-5 font-heading text-4xl font-bold leading-tight">
            Tu información financiera, tus decisiones y tus datos bajo tu
            control.
          </h2>
          <p className="mt-5 leading-7 text-white/70">
            Una herramienta pensada para emprendedoras bolivianas, con lenguaje
            claro y fuentes oficiales.
          </p>
        </div>
        <div className="relative flex items-center gap-2 text-sm text-white/65">
          <ShieldCheck className="size-4" /> Tus conversaciones privadas no se
      ...
      <section className="flex items-center justify-center p-5 sm:p-10">
        <div className="w-full max-w-md">
          <Link
            href="/"
            className="mb-8 inline-flex items-center gap-2 text-sm font-semibold text-muted-foreground hover:text-primary"
          >
            <ArrowLeft className="size-4" /> Volver al inicio
          </Link>
          <div className="mb-8 lg:hidden">
            <span className="inline-flex items-center gap-2 font-heading text-xl font-bold text-primary">
              <Sparkles className="size-5" /> Kawsay
            </span>
          </div>
