...
| Diagnóstico | `/diagnostic-questions`, `/diagnostic-sessions`, `/formalization-routes`, `/formalization-steps` | `business.manage_own` |
...
No hay HTTP para organizaciones ni `business_memberships`. Esas tablas siguen siendo reserva de esquema (ADR 001).
